...
var $author$project$Main$Grammar = F2(
	function (a, b) {
		return {$: 'Grammar', a: a, b: b};
	});
var $author$project$Data$OneOrMore$OneOrMore = F2(
	function (a, b) {
	...
	return _Utils_Tuple2(
		{
			...
			semantics: A2(
				$author$project$Data$OneOrMore$OneOrMore,
				$author$project$Main$Axiom(
					A2($author$project$Main$Step, '(λx. e) v', 'e{v/x}')),
				_List_fromArray(
					[
						A2(
						$author$project$Main$Rule,
						_List_fromArray(
							[
								A2($author$project$Main$Step, 'e', 'e′')
							]),
						A2($author$project$Main$Step, 'E[e]', 'E[e′]'))
					])),
			template: $elm$core$Maybe$Nothing
		},
...
var $author$project$Main$stepTitle = F3(
	function (number, string, editing) {
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text(
						$elm$core$String$fromInt(number) + ('. ' + string))),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
					...
					$mdgriffith$elm_ui$Element$text(
						_Utils_eq(
							editing,
							$elm$core$Maybe$Just(number)) ? 'Save' : 'Edit'))
				]));
	});
...
var $author$project$Main$OnDomainEditName = F2(
	function (a, b) {
		return {$: 'OnDomainEditName', a: a, b: b};
	});
var $author$project$Main$OnDomainEditVars = F2(
	function (a, b) {
		return {$: 'OnDomainEditVars', a: a, b: b};
	});
...
var $author$project$Main$boldFont = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Font$typeface('LMRoman10-Bold'),
...
var $author$project$Main$borderBottom = $mdgriffith$elm_ui$Element$Border$widthEach(
...
var $author$project$Main$viewDomains = F2(
...
var $author$project$Main$viewSemantics = function (_v0) {
	var first = _v0.a;
	var rest = _v0.b;
	var viewStep = function (_v2) {
		var a = _v2.a;
		var b = _v2.b;
		return A2(
			$mdgriffith$elm_ui$Element$el,
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$core$List$map, viewStep, precs)),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
	...
	var viewSingle = function (semantics) {
		if (semantics.$ === 'Axiom') {
			var conclusion = semantics.a;
			return A2(viewRule, _List_Nil, conclusion);
		} else {
			var precs = semantics.a;
			var conclusion = semantics.b;
			return A2(viewRule, precs, conclusion);
		}
	};
	return A2(
		$mdgriffith$elm_ui$Element$row,
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$Font$typeface('LMRoman10-Regular'),
									$mdgriffith$elm_ui$Element$Font$sansSerif
								]))
						]),
					_List_fromArray(
						[
							$author$project$Main$title('Programming Language Playground'),
							A2(
							...
							$author$project$Main$viewSemantics(model.semantics),
							A3($author$project$Main$stepTitle, 3, 'Evaluate an expression', model.editing)
						])))
			]),
		title: 'Playground'
	};
