...
var $author$project$Main$OneOrMore = F2(
	function (a, b) {
	...
	return _Utils_Tuple2(
		{
			...
			semantics: A2(
				...
				$author$project$Main$Axiom(
					A2($author$project$Main$Step, 'x', 'x\'')),
				_List_Nil),
...
var $author$project$Main$stepTitle = function (string) {
	return A2(
...
var $author$project$Main$viewDomains = function (_v0) {
	var first = _v0.a;
	var rest = _v0.b;
	var withCommas = function (chars) {
...
var $author$project$Main$asItalic = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Font$typeface('cmu_serifitalic'),
...
var $author$project$Main$viewGrammar = function (_v0) {
	var first = _v0.a;
	var rest = _v0.b;
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$Font$typeface('cmu_serifroman'),
									$mdgriffith$elm_ui$Element$Font$sansSerif
								]))
						]),
					_List_fromArray(
						[
							...
							$author$project$Main$stepTitle('1. Define the grammar'),
							$author$project$Main$viewDomains(model.domains),
							$author$project$Main$viewGrammar(model.grammar),
							$author$project$Main$stepTitle('2. Define the semantics'),
							$author$project$Main$stepTitle('3. Evaluate an expression')
						])))
			]),
		title: 'Playground'
	};
